...
export class FaceTracker {
  ...
  private setupMediaPipe() {
    ...
    this.controlsElement = document.getElementById(
      'control-panel'
    ) as HTMLDivElement;
    this.canvasContainerElement = document.getElementById(
      'canvas-container'
    ) as HTMLDivElement;
    this.gameContainerElement = document.getElementById('phaser-game') as HTMLDivElement;
